...
<section>
    ...
    <table>
      ...
      <tr>
        <td colspan="3">${map.boardVo1.btitle }<strong></strong></td>
      </tr>
      <tr>
        <td>${map.boardVo1.bname}</td>
        <td>조회수</td>
        <td>${map.boardVo1.bhit}</td>
      </tr>
      <tr>
        <td colspan="3" class="article">${map.boardVo1.bcontent}</td>
      </tr>
      <tr>
