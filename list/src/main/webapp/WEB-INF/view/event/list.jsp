...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>이벤트 게시판</strong><span>쟈뎅샵 소식을 전해드립니다.</span></h2>
					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<c:forEach items="${map.list }" var="list">
								<tr>
									<td class="tnone">${list.bid }</td>
									<td class="left">
										<a href="/event/view?bid=${list.bid }">${list.btitle} : ${now }</a>
										<img src="../images/ico/ico_new.gif" alt="NEW" />
							<c:set var="bdate"><fmt:formatDate value="${today}" pattern="yyyy-MM-dd" /></c:set>
									<td>${bdate}			
									</td>
									<td class="tnone right">${list.bhit}</td>
								</tr>
							</c:forEach>
							</tbody>
						</table>
